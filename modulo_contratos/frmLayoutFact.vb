...
Public Class frmLayoutFact
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Mandacorreofase(usuarioglobal, "LAYOUT_FIRA", "Descuento Fira Factoraje lote " & ComboBox2.SelectedValue, "Se ha generado el layout del lote " & ComboBox2.SelectedValue & " para solicitar recurso el " & DTFecha.Text & " por $" & total.ToString("n2"), usuarioglobal)
