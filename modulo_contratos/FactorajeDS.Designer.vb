    ...
    Partial Public Class CONT_CPF_Factor_FacturasTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT  TOP 3     id_Factura, Factura, RFC, [RFC CONTRAPARTE], [MONTO SOLICITADO]"& _ 
                ...
                "M            CONT_CPF_Factor_Facturas"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Procesado = 0) and lote=@lo"& _ 
                "te"
    ...
    Partial Public Class WEB_LotesTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Id_Lote, Fecha, Usuario, Estatus, TipoDocumento, Cesion"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM      "& _ 
                "      WEB_Lotes"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (TipoDocumento = 'fira') AND (Estatus = 'Pendiente"& _ 
