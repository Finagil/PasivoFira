...
Public Class rpt_cl_plazo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Fira_Cartera_Pasiva.rpt_cl_plazo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_cl_plazo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_cl_plazo = New rpt_cl_plazo()
        rpt.Site = Me.Site
        Return rpt
    End Function
