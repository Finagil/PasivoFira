...
Public Class rpt_subreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Fira_Cartera_Pasiva.rpt_subreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_subreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_subreport = New rpt_subreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
