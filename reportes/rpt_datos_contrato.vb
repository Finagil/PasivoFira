...
Public Class rpt_datos_contrato
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Fira_Cartera_Pasiva.rpt_datos_contrato.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_datos_contrato
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_datos_contrato = New rpt_datos_contrato()
        rpt.Site = Me.Site
        Return rpt
    End Function
