...
Public Class rpt_prueba02
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Fira_Cartera_Pasiva.rpt_prueba02.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_prueba02
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_prueba02 = New rpt_prueba02()
        rpt.Site = Me.Site
        Return rpt
    End Function
